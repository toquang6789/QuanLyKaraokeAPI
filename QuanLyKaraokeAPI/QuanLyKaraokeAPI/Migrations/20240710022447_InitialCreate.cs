    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IdentityUserLogin<int>", x => new { x.LoginProvider, x.ProviderKey, x.UserId });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TableID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TabelName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Image = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConvertUnit = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostPrite = table.Column<float>(type: "real", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceTime", x => x.ServiceID);
                    table.ForeignKey(
                        name: "FK_ServiceTime_Categories_CategoriesID",
                        column: x => x.CategoriesID,
                        principalTable: "Categories",
                        principalColumn: "CategoriesID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ImportProducts", x => x.IdImport);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Oders_Account_AccountID",
                        column: x => x.AccountID,
                        principalTable: "Account",
                        principalColumn: "AccountID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Oders_Tables_TableID",
                        column: x => x.TableID,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Quantity = table.Column<int>(type: "int", nullable: false),
                    UnitID = table.Column<int>(type: "int", nullable: false),
                    Monney = table.Column<float>(type: "real", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_DetailImports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DetailImports_ImportProducts_IdImport",
                        column: x => x.IdImport,
                        principalTable: "ImportProducts",
                        principalColumn: "IdImport",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetailImports_Products_ProductID",
                        column: x => x.ProductID,
                        principalTable: "Products",
                        principalColumn: "ProductID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DetailImports_units_UnitID",
                        column: x => x.UnitID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrdersProduct_Oders_OderID",
                        column: x => x.OderID,
                        principalTable: "Oders",
                        principalColumn: "OderID",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersService", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrdersService_Oders_OderID",
                        column: x => x.OderID,
                        principalTable: "Oders",
                        principalColumn: "OderID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrdersService_ServiceTime_ServiceID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DetailImports_IdImport",
                table: "DetailImports",
                column: "IdImport");

            migrationBuilder.CreateIndex(
                name: "IX_DetailImports_ProductID",
                table: "DetailImports",
                column: "ProductID");

            migrationBuilder.CreateIndex(
                name: "IX_DetailImports_UnitID",
                table: "DetailImports",
                column: "UnitID");

            migrationBuilder.CreateIndex(
                name: "IX_HoaDons_OderID",
                table: "HoaDons",
                column: "OderID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdersService_OderID",
                table: "OrdersService",
                column: "OderID");

            migrationBuilder.CreateIndex(
                name: "IX_OrdersService_ServiceID",
                table: "OrdersService",
                column: "ServiceID");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceTime_CategoriesID",
                table: "ServiceTime",
                column: "CategoriesID");
        }
